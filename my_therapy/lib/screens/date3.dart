...
class Date3 extends StatelessWidget {
  const Date3({super.key});
                ...
                child: SingleChildScrollView(
                  child: Column(
                    ...
                    children: [
                      ...
                      //logo
                      const SizedBox(height: 30),
                      Image.asset('lib/images/sad.jpg', height: 100),
                      ...
                      Row(
                        children: [
                          circle_progressindicator(curStep: 14),
                          const SizedBox(width: 50),
                          circle_progressindicator(curStep: 30)
                        ],
                      ),
                      const SizedBox(height: 10),
                      Row(
                        children: [
                          ...
                          const Text('472 steps',
                              textAlign: TextAlign.left,
                              style: TextStyle(
                                  fontSize: 20,
                                  color: Color.fromARGB(255, 43, 43, 43))),
                          const SizedBox(width: 110),
                          const Text('920 calories',
